...
setpoint = [1063,345]#[217,1063]#[640,640]
...
prev_error = [0,0]
 ...
 #set accordingly
kp = [0.003,0.003]#[0.003,0.003]#[0.0017,0.0017]#[0.004,0.004]
kd = [0.01,0.01]#[0.0073,0.0073]#[0.0035,0.0035]#[0.009,0.009]
ki = [0.002,0.002]#[0.002,0.002]#[0.00000,0.00000]#[0.000,0.000]
limiting = 2.0
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@2
	...
	if (1):#(dt >= sample_time): # code is running 	for a sample time
		...
		print("x_output:",angle_x,"    y_output:",angle_y)
	...
	#	print("--------------------------------------------")
		...
		if ((perror[0] < 50) or (perror[0] < -50)) and ((perror[1] > 50) or (perror[1] > -50)):
			print("***************")
			print("***************")
			print("***************")
			print("***************")
			print("WAY POINIT ACHIEVED")
