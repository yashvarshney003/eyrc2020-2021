...
# Global variables: client_id, setpoint=[],current_time,prev_time,perror,derror,ierror,prev_error
...
def control_logic(client_id,center_x,center_y,servohandle_x,servohandle_y):
	...
	`servohandle_x`  : [int]
		servo handle number attached to top plate to tilt in x_direction
	
	`servohandle_y`  : [int]
		servo handle number attached to top plate to tilt in y_direction
	...
	Example call:
	---
	control_logic(client_id,center_x,center_y,servohandle_x,servohandle_y)
